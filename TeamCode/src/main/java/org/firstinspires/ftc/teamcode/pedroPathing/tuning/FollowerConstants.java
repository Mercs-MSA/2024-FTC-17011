...
public class FollowerConstants {
    public static Pose startingPoseLeft = new Pose(6.75, 63, Math.toRadians(90));
    ...
    private static double xMovement = 76.49238095520795;
    private static double yMovement = 61.84278628327606;
    ...
    public static double mass = 12.8;
    ...
    public static double forwardZeroPowerAcceleration = -1; //-20.96460206456467;

    // Acceleration of the drivetrain when power is cut in inches/second^2 (should be negative)
    // if not negative, then the robot thinks that its going to go faster under 0 power
    public static double lateralZeroPowerAcceleration = -1; //-80.62485150425947;
