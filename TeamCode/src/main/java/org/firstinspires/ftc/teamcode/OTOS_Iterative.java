...
public class OTOS_Iterative {
    ...
    private static final double OTOS_LINEAR_SCALAR  = 1.0331;
    private static final double OTOS_ANGULAR_SCALAR = .9801;

    private static final double OTOS_MOUNTING_OFFSET_X = 1.4375;
    private static final double OTOS_MOUNTING_OFFSET_Y = 5.875;
    private static final double OTOS_MOUNTING_OFFSET_Z = 180;
