...
public class LocalizationTest extends OpMode {
    ...
    private Pose newPose = new Pose(-11.25, 35.95, Math.toRadians(360));
    /**
    ...
    public void init() {
        ...
        poseUpdater.setStartingPose(startingPoseFourSpec);
        ...
        leftFront.setDirection(DcMotor.Direction.FORWARD); //V1 - REVERSE
        leftRear.setDirection(DcMotor.Direction.FORWARD); //V1 - REVERSE
        rightFront.setDirection(DcMotor.Direction.REVERSE); //V1 - FORWARD
        rightRear.setDirection(DcMotor.Direction.REVERSE); //V1 - FORWARD
