...
public class Follower {
    ...
    public void initialize() {
        ...
        leftFront.setDirection(DcMotorSimple.Direction.FORWARD); //V2 - Forward
        leftRear.setDirection(DcMotorSimple.Direction.FORWARD); //V2 - Forward
        rightRear.setDirection(DcMotorSimple.Direction.REVERSE); //V2 - Reverse
        rightFront.setDirection(DcMotorSimple.Direction.REVERSE); //V2 - Reverse
